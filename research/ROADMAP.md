...
- [ ] **A — Live / research parity**: prove live and replay apply the same rules (timestamps, reference candle, cutoffs, feature windows, targets, fallbacks, missing-data, timing, versions); automated checks where practical.
